...
const ReminderSection = document.querySelector("#myReminders");
...
myreminders = new Todo_Class(ReminderSection);
...
document.querySelector("#Donotforget").addEventListener("keydown", function(e){ 
    if (e.keyCode == 13) {
        myreminders.add()
    }
     }   )